        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="space-y-2 text-sm text-gray-600">
              ...
              <p>
                ...
                <Link href="mailto:contact@hizencompass.com" className="text-[#7b1e7a] hover:underline ml-1">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li>
                <Link href="/analysis/record-input" className="hover:text-[#7b1e7a]">
                  생기부 분석
                </Link>
              </li>
              <li>
                <Link href="/main/input" className="hover:text-[#7b1e7a]">
                  모의고사 분석
                </Link>
              </li>
              <li>
                <Link href="/susi/record-input" className="hover:text-[#7b1e7a]">
                  수시 예측
                </Link>
              </li>
              <li>
                <Link href="/jungsi/score-input" className="hover:text-[#7b1e7a]">
                  정시 예측
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li>
                <Link href="/support/faq" className="hover:text-[#7b1e7a]">
                  자주묻는질문
                </Link>
              </li>
              <li>
                <Link href="/support/contact" className="hover:text-[#7b1e7a]">
                  문의하기
                </Link>
              </li>
              <li>
                <Link href="/support/guide" className="hover:text-[#7b1e7a]">
                  이용가이드
                </Link>
              </li>
            </ul>
