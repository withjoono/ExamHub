...
export default function CumulativeAnalysis() {
  ...
  const statistics = [
    ...
    { label: "", value: "94", unit: "문항", color: "text-[#7b1e7a]" },
  ]
        ...
        <div className="h-64 flex items-end justify-center space-x-8 px-8">
          <div className="flex items-center space-x-4 mb-4 absolute top-4 right-4">
            <div className="flex items-center space-x-2">
              <div className="w-3 h-3 bg-[#9c3d9a] rounded"></div>
          ...
          {months.map((month, index) => (
            <div key={month} className="flex flex-col items-center">
              <div className="relative">
                ...
                {index < months.length - 1 && <div className="absolute -top-5 left-2 w-8 h-0.5 bg-[#9c3d9a]"></div>}
              </div>
              <span className="text-sm text-gray-600 mt-2">{month}</span>
            </div>
          ))}
          ...
          {months.map((month, index) => (
            <div key={month} className="flex flex-col items-center">
              <div className="relative flex space-x-1">
                ...
                ></div>
                <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 w-2 h-2 bg-[#9c3d9a] rounded-full"></div>
                {index < months.length - 1 && <div className="absolute -top-5 left-8 w-8 h-0.5 bg-[#9c3d9a]"></div>}
              </div>
              <span className="text-sm text-gray-600 mt-2">{month}</span>
            </div>
          ))}
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center space-x-2 text-sm text-gray-500">
            ...
            <span>모의고사 분석</span>
            <span>&gt;</span>
            <span className="text-[#7b1e7a] font-medium">누적 분석</span>
          </div>
        </div>
      </div>
          ...
          <div className="flex items-center space-x-4 mb-4">
            <button
              ...
              className={`px-4 py-2 rounded-md text-sm font-medium ${
                viewMode === "all" ? "bg-[#7b1e7a] text-white" : "bg-gray-100 text-gray-700 hover:bg-gray-200"
              }`}
            >
              전과목 분석
            </button>
            <button
              ...
              className={`px-4 py-2 rounded-md text-sm font-medium ${
                viewMode === "by-subject" ? "bg-[#7b1e7a] text-white" : "bg-gray-100 text-gray-700 hover:bg-gray-200"
              }`}
            >
              과목별 분석
            </button>
              ...
              <div className="flex items-center space-x-4 mb-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-32 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#7b1e7a] focus:border-[#7b1e7a]"
                  >
