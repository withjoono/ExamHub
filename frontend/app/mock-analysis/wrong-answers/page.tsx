    ...
    for (let i = 1; i <= 45; i++) {
      ...
      questions.push(
        <button
          ...
          } ${selectedQuestion === i ? "ring-2 ring-[#7b1e7a]" : ""}`}
        >
          {i}
        </button>,
      )
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="bg-gray-50 rounded-lg p-4 mb-6">
            <div className="grid grid-cols-4 gap-4">
              <div className="text-center">
                ...
                <div className="text-2xl font-bold text-[#7b1e7a]">{stats.totalWrong}</div>
                <div className="text-sm text-gray-500">문항</div>
              </div>
              <div className="text-center">
                <div className="text-sm text-gray-600 mb-1">총 정답</div>
                <div className="text-2xl font-bold text-[#7b1e7a]">{stats.totalPoints}</div>
                <div className="text-sm text-gray-500">점</div>
              </div>
              <div className="text-center">
                <div className="text-sm text-gray-600 mb-1">백분위 오답 개수</div>
                <div className="flex items-center justify-center space-x-2">
                  <span className="text-lg font-bold text-[#7b1e7a]">2점 문항 {stats.twoPointWrong}</span>
                </div>
              </div>
              <div className="text-center">
                <div className="text-sm text-gray-600 mb-1"></div>
                <div className="flex items-center justify-center space-x-2">
                  <span className="text-lg font-bold text-[#7b1e7a]">3점 문항 {stats.threePointWrong}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 flex justify-center">
            <button className="bg-[#7b1e7a] hover:bg-[#5a1559] text-white px-8 py-3 rounded-lg font-medium transition-colors">
              입력페이지로
            </button>
          </div>
        </div>
