            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="overflow-x-auto">
                <table className="w-full border-collapse text-xs">
                  <thead>
                    <tr className="border-b bg-gray-50">
                      <th rowSpan={2} className="text-left p-2 text-xs font-medium text-gray-700 border-r">
                        과목
                      </th>
                      <th colSpan={2} className="text-center p-2 text-xs font-medium text-gray-700 border-r">
                        A대학
                      </th>
                      <th colSpan={2} className="text-center p-2 text-xs font-medium text-gray-700 border-r">
                        B대학
                      ...
                      <th colSpan={2} className="text-center p-2 text-xs font-medium text-gray-700">
                        D대학
                      </th>
                      <th rowSpan={2} className="text-center p-2 text-xs font-medium text-gray-700">
                        비율
                      </th>
                    </tr>
                    <tr className="border-b bg-gray-50">
              ...
              <div className="flex flex-col">
                <div className="h-48 flex items-end justify-between space-x-1 mb-4">
                  {["7월모의고사", "7월모의고사", "7월모의고사", "7월모의고사"].map((label, index) => (
                    <div key={index} className="flex flex-col items-center flex-1">
                      <div
                        className="w-full bg-[#7b1e7a] rounded-t-sm"
                        style={{
                          height: `${(index + 1) * 30 + 20}px`,
                        }}
                      ></div>
                ...
                <p className="text-xs text-gray-600 mt-4">
                  반영 비율이 반영비율에 따라 대학별 내 점수가 다르게 산출되니 대학별 반영비율을 확인하여 지원전략을
                  세우시기 바랍니다.
                </p>
              </div>
            </div>
              ...
              {chartData.map((item, index) => (
                <div key={index} className="flex items-center space-x-4">
                  ...
                  <div className="flex-1 bg-gray-200 rounded-full h-6 relative">
                    <div
                      className="bg-[#7b1e7a] h-6 rounded-full flex items-center justify-end pr-2"
